...
par(mfrow = c(2,2))
# topleft figure
with(dfs2, plot(Date_Time, Global_active_power, type = "l", xaxt = "n", xlab = "", ylab = "Global Active Power"))
ticks <- ymd_hms(c("2007-02-01 00:00:00","2007-02-02 00:00:00", "2007-02-03 00:00:00"))
axis(1, at = ticks, labels = wday(ticks, label = TRUE))
# topright figure
with(dfs2, plot(Date_Time, Voltage, type = "l", xaxt = "n", xlab = "datetime"))
axis(1, at = ticks, labels = wday(ticks, label = TRUE))
# bottomleft figure
...
legend("topright", lty = 1, col = c("black", "red", "blue"), 
       ...
       bty = "n")
# bottom right figure
with(dfs2, plot(Date_Time, Global_reactive_power, type = "l", xaxt = "n", xlab = "datetime"))
axis(1, at = ticks, labels = wday(ticks, label = TRUE))
dev.off()
